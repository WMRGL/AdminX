...
namespace AdminX.Meta
{
    interface ICRUD
    {
       ...
       public int CallStoredPatientProcedure(string sType, string sOperation, int int1, DateTime dDate1, bool bool1, string? sLogin = "", int? int2 = 0, int? int3 = 0,
            string? string1 = "", string? string2 = "", string? string3 = "", string? text = "",
            DateTime? dDate2 = null, bool? bool2 = false,
            int? int4 = 0, int? int5 = 0, int? int6 = 0, string? string4 = "", string? string5 = "", string? string6 = "",
            float? f1 = 0, float? f2 = 0, float? f3 = 0, float? f4 = 0, float? f5 = 0, string? string7 = "");
    }
     ...
     float? f1 = 0, float? f2 = 0, float? f3 = 0, float? f4 = 0, float? f5 = 0, string? string7 = "")
        {
            ...
            if (string6 == null) { string6 = ""; }
            sLogin = "iolatunbosun";
            int2 =0; int3 =0; int4 =0; int5 =0; int6 =0;
            string1 = "";
            string2 = "";
            string3 = "";
