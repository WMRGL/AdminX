...
namespace AdminX.Meta
{
    interface ICRUD
    {
        ...
        int ReferralDetail(string sType, string sOperation, string sLogin, int int1, string string1, string string2, string string3, string text,
            ...
            float? f1 = 0, float? f2 = 0, float? f3 = 0, float? f4 = 0, float? f5 = 0, string? string44 = "");
                              ...
                              //list of integers, strings, dates, and booleans that are passed to it.
    {
        ...
        public int ReferralDetail(string sType, string sOperation, string sLogin, int int1, string string1, string string2, string string3, string text,
            string? string4 = "", string? string5 = "", string? string6 = "", string? string7 = "", string? string8 = "", string? string9 = "",
            string? string10 = "", string? string11 = "", string? string12 = "", DateTime? dDate1 = null, DateTime? dDate2 = null, string? string13 = "", int? int2 = 0, int? int3 = 0, int? int4 = 0,
            int? int5 = 0, int? int6 = 0, int? int7 = 0,
                  //  int int2, int int3,
