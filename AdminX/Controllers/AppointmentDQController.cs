...
{
    public class AppointmentDQController : Controller
    {
        private readonly IAppointmentDQData _appointmentDQData;

        public AppointmentDQController(IAppointmentDQData appointmentDQData)
        {
            _appointmentDQData = appointmentDQData;
        }
        [HttpGet]
